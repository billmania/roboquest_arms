...
def enter_pressed() -> bool:
    """Report when the ENTER key has been pressed.

    Defined here to avoid importing the utils.py module.
    It's only usable on a Linux platform.
    """
    return select([sys.stdin], [], [], 0)[0] and sys.stdin.readline().strip() == ""
